...
export function WireframeVisual({ type, className, label }: WireframeVisualProps) {
  ...
  const base = "w-full overflow-hidden relative flex flex-col p-3 min-h-[48px] justify-start items-start transition-all";
  
  // Helper for text label inside the block (white text) - ALWAYS Top-Left
  const BlockLabel = () => (
    <span className={cn(
      "text-white text-[11px] font-bold leading-tight mb-2 truncate block opacity-95 shadow-sm text-left w-full"
    )}>
  ...
  switch (type) {
    ...
    case 'map':
       return (
         <div className={cn(base, "bg-[#3B82F6] h-[80px]", className)}>
            <BlockLabel />
            <div className="mt-1 flex-1 w-full relative bg-white/20 rounded-sm overflow-hidden grid grid-cols-3 gap-px border border-white/20">
    ...
    case 'table':
       return (
         <div className={cn(base, "bg-[#3B82F6] h-[70px]", className)}>
            <BlockLabel />
            <div className="flex flex-col gap-1.5 mt-2 opacity-60 w-full">
    ...
    case 'audio':
       return (
          <div className={cn(base, "bg-[#3B82F6] h-[50px]", className)}>
             <div className="flex justify-center items-end gap-0.5 h-4 w-full">
                {[...Array(12)].map((_, i) => (
    ...
    case 'post_thread':
       return (
          <div className={cn(base, "bg-[#3B82F6] h-[70px]", className)}>
             <BlockLabel />
             <div className="ml-1 pl-2 border-l border-white/20 mt-1 space-y-1 w-full">
                <Line w="w-full" h="h-1" />
                <Line w="w-3/4" h="h-1" />
             </div>
          </div>
    ...
    case 'chart':
       return (
         <div className={cn(base, "bg-[#3B82F6] h-[70px]", className)}>
            <BlockLabel />
            <div className="flex items-end gap-1 h-5 mt-1 w-full">
